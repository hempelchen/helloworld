...
public class FormClient extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.im_formclient);
				...
				chat.addMessageListener(new MessageListener() {
					...
					public void processMessage(Chat chat2, Message message) {
						...
						if(message.getFrom().contains("test2@sam")){
							...
							msg.obj = args;
							msg.sendToTarget();
						}else if (message.getFrom().contains("chb1")){
							// orther user / group / admin of the openfire
							// do work...
							String[] args = new String[] { "chb1", message.getBody(), TimeRender.getDate(), "IN" };
							android.os.Message msg = handler.obtainMessage();
							msg.what = 1;
							msg.obj = args;
							msg.sendToTarget();
						} else if (message.getFrom().contains("chb2")){
							// orther user / group / admin of the openfire
							// do work...
							String[] args = new String[] { "chb2", message.getBody(), TimeRender.getDate(), "IN" };
							android.os.Message msg = handler.obtainMessage();
							msg.what = 1;
							msg.obj = args;
							msg.sendToTarget();
	...
	class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(listMsg.get(position).from.equals("IN")){
				convertView = this.inflater.inflate(R.layout.im_formclient_chat_in, null);
			}else{
				convertView = this.inflater.inflate(R.layout.im_formclient_chat_out, null);
			}
